...
<div class=" flex flex-col w-4/12 mx-auto shadow-xl bg-white bg-opacity-90 rounded-xl py-6 mt-10 px-10">
    ...
    <form action="<?= base_url("/auth"); ?>" method="POST">
        ...
        <button type="submit" class="btn btn-primary mt-4 btn-block text-white" style="">LOGIN</button>
    </form>
</div>
    <div class="container mt-20">
        ...
        <div class="col-md-4 col-sm-12 mb-3">
            ...
            <div class="card text-dark" style="">
                ...
                <div class="card-body">
                    <div class="card-title"><h4>Tentang Sekolah</h4></div>
                </div>
            </div>
            </a>
        </div>
        ...
        <div class="col-md-4 col-sm-6 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-title"><h4>Apa Itu LMS?</h4></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 mb-3">
            <div class="card mb-20">
                ...
                <div class="card-body">
                    <div class="card-title"><h4>Belajar Online</h4></div>
                </div>
            </div>
        </div>
    </div>
