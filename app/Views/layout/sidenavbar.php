<div class="row no-gutters mt-5 ">
    <div class="col-md-2 bg-sidebar mt-2 pr-3 pt-4" id="sidebar">
        ...
        <ul class="nav flex-column ml-3 mb-5 mt-10" >
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin/update"><i class="fas fa-plus-square fa-lg mr-3"></i>Update</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/admin/tampilan"><i class="fas fa-book-open fa-lg mr-3"></i>Tampil</a>
            </li>
        </ul>
    </div>
