        ...
        <div class="col-8">
            ...
            <form action="/admin/saveAdmin" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text"
                            class="form-control <?= ($validationAdmin->hasError('alamat')) ? 'is-invalid':''; ?>"
                            name="alamat" id="alamat" value="<?= old('alamat'); ?>">
                        <div class="invalid-feedback">
                            <?= $validationAdmin->getError('alamat'); ?>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="email"
                            class="form-control  <?= ($validationAdmin->hasError('email_user')) ? 'is-invalid':''; ?> "
                            name="email_user" id="email_user" value="<?= old('email_user'); ?>">
                        <div class="invalid-feedback">
                            <?= $validationAdmin->getError('email_user'); ?>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
